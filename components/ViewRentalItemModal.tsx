...
<DialogContent className=" bg-gradient-to-br from-gray-900/98 to-black/98 backdrop-blur-xl border border-gray-700/50 text-white p-0   min-w-[90vw] h-[90vh] overflow-y-auto">
